...
struct SwiftfulUI: View {
    ...
    var body: some View {
        ...
        // MARK: AsyncViewBuilder, ViewModifiers, RootView,  CountdownViewBuilder, Strecthy Header
        ZStack {
...
// MARK: LazyVGrid, Grid, Progress bars, Redacted
...
// MARK: Backgrouds and Borders, Button, Geometry Readers
//        Text("Hello, world")
//            .padding()
